...
public class DeliverOut {
	...
	private String sellOutId;//关联订货单Id
	private Long customId;//顾客编号
	private String customPhone;//顾客电话
	private String customAddr;//顾客地址
	private List<DeliverOutDetail> deliverOutDetailList = new ArrayList<DeliverOutDetail>();
	...
	public List<DeliverOutDetail> getDeliverOutDetailList() {
		return deliverOutDetailList;
	}

	public void setDeliverOutDetailList(List<DeliverOutDetail> deliverOutDetailList) {
		this.deliverOutDetailList = deliverOutDetailList;
	}
